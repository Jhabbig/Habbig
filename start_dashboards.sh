...
#   7062 — Religion & Cults Dashboard (religion-dashboard/server.py)
...
ALL_PORTS="7000 8000 8050 8051 8052 5050 8888 7050 7054 7060 7062 7070 8053"
...
start_all() {
    ...
    echo -e "${GREEN}[1/13]${NC} Starting Crypto Dashboard on port 8000..."
    ...
    echo -e "${GREEN}[2/13]${NC} Starting Stock Dashboard on port 8050..."
    ...
    echo -e "${GREEN}[3/13]${NC} Starting Midterm Dashboard on port 8051..."
    ...
    echo -e "${GREEN}[4/13]${NC} Starting Top Traders Dashboard on port 8052..."
    ...
    echo -e "${GREEN}[5/13]${NC} Starting Weather Dashboard on port 5050..."
    ...
    echo -e "${GREEN}[6/13]${NC} Starting Sports Dashboard on port 8888..."
    ...
    # 9. Crypto Trackers Dashboard (port 7054)
    echo -e "${GREEN}[9/13]${NC} Starting Crypto Trackers Dashboard on port 7054..."
    ...
    # 10. Religion & Cults Dashboard (port 7062)
    echo -e "${GREEN}[10/13]${NC} Starting Religion & Cults Dashboard on port 7062..."
    cd "$SCRIPT_DIR/religion-dashboard"
    PORT=7062 python3 server.py > /tmp/dashboard_religion.log 2>&1 &
    echo $! > /tmp/dashboard_religion.pid
    echo "       PID: $(cat /tmp/dashboard_religion.pid)"
    cd "$SCRIPT_DIR"

    # 11. AI Race Dashboard (port 7070)
    echo -e "${GREEN}[11/13]${NC} Starting AI Race Dashboard on port 7070..."
    ...
    # 12. Whale Watch Dashboard (port 8053)
    echo -e "${GREEN}[12/13]${NC} Starting Whale Watch on port 8053..."
