...
PEOPLE: list[dict] = [
    ...
    # ── v2.4 — extended Fed Board ──────────────────────────────────────────
    {
        "regulator":  "Fed",
        "role":       "Vice Chair",
        "name":       "Philip Jefferson",
        "term_end":   "2027-09-07",
        "term_type":  "Vice Chair term end",
        "source_url": "https://www.federalreserve.gov/aboutthefed/bios/board/jefferson.htm",
        "notes":      "Sworn in as Vice Chair September 2023.",
    },
    {
        "regulator":  "Fed",
        ...
        "term_end":   "2034-01-31",
        "term_type":  "Governor term end",
        "source_url": "https://www.federalreserve.gov/aboutthefed/bios/board/bowman.htm",
        "notes":      "Confirmed June 2025 as Vice Chair for Supervision.",
    },
    {
        "regulator":  "Fed",
        "role":       "Governor",
        ...
        "term_end":   "2030-01-31",
        "term_type":  "Governor term end",
        "source_url": "https://www.federalreserve.gov/aboutthefed/bios/board/waller.htm",
        "notes":      "Sworn in December 2020.",
    },
    {
        "regulator":  "Fed",
        "role":       "Governor",
        ...
        "term_end":   "2038-01-31",
        "term_type":  "Governor term end",
        "source_url": "https://www.federalreserve.gov/aboutthefed/bios/board/cook.htm",
        "notes":      "Reconfirmed September 2023 for full 14-year term.",
    },
    {
        "regulator":  "Fed",
        "role":       "Governor",
        ...
        "term_end":   "2026-01-31",
        "term_type":  "Governor term end",
        "source_url": "https://www.federalreserve.gov/aboutthefed/bios/board/kugler.htm",
        "notes":      "Filling the unexpired term of a prior Governor; renomination is the market-relevant event.",
    },

    # ── v2.4 — CFTC Commissioners ──────────────────────────────────────────
    {
        "regulator":  "CFTC",
        "role":       "Commissioner",
        ...
        "term_end":   "2028-04-13",
        "term_type":  "Commissioner term end",
        "source_url": "https://www.cftc.gov/About/Commissioners/SummerMersinger",
        "notes":      "Sworn in March 2023.",
    },
    {
        "regulator":  "CFTC",
        "role":       "Commissioner",
        ...
        "term_end":   "2027-04-13",
        "term_type":  "Commissioner term end",
        "source_url": "https://www.cftc.gov/About/Commissioners/KristinJohnson",
        "notes":      "Sworn in March 2022.",
    },

    # ── v2.4 — US banking regulators ───────────────────────────────────────
    {
        "regulator":  "OCC",
        "role":       "Comptroller",
        "name":       "Jonathan Gould",
        "term_end":   "2030-07-09",
        "term_type":  "Five-year term end",
        "source_url": "https://www.occ.gov/about/who-we-are/leadership/index-leadership.html",
        "notes":      "Confirmed July 2025 for a five-year term.",
    },
    {
        "regulator":  "FDIC",
        "role":       "Acting Chair",
        "name":       "Travis Hill",
        "term_end":   "",
        "term_type":  "Acting role",
        "source_url": "https://www.fdic.gov/about/leadership-organization",
        "notes":      "Named Acting Chair January 2025 pending Chair confirmation.",
    },
    {
        "regulator":  "FinCEN",
        "role":       "Director",
        "name":       "Andrea Gacki",
        "term_end":   "",
        "term_type":  "Director (govt appointment)",
        "source_url": "https://www.fincen.gov/about/leadership-organization/andrea-gacki",
        "notes":      "Took office July 2023.",
    },

    # ── v2.4 — international/supranational leadership ──────────────────────
    {
        "regulator":  "BIS",
        ...
        "term_end":   "2025-09-30",
        "term_type":  "Second term end",
        "source_url": "https://www.bis.org/about/orggov.htm",
        "notes":      "Reappointed for a second five-year term ending September 2025; successor announcement is the market-relevant event.",
    },
    {
        "regulator":  "IOSCO",
        "role":       "Chair",
        "name":       "Jean-Paul Servais",
        "term_end":   "2026-12-31",
        "term_type":  "Board re-election cycle",
        "source_url": "https://www.iosco.org/about/?subsection=display_committee&cmtid=63",
        "notes":      "Chair of the IOSCO Board since 2022.",
    },
    {
        "regulator":  "FATF",
        "role":       "President",
        "name":       "Elisa de Anda Madrazo",
        "term_end":   "2026-06-30",
        "term_type":  "Two-year term end",
        "source_url": "https://www.fatf-gafi.org/en/the-fatf/who-we-are/fatf-president.html",
        "notes":      "Took office July 2024 for a two-year term.",
    },

    # ── v2.4 — additional ECB Executive Board ──────────────────────────────
    {
        "regulator":  "ECB",
        "role":       "Vice President",
        ...
        "term_end":   "2026-05-31",
        "term_type":  "Eight-year term end",
        "source_url": "https://www.ecb.europa.eu/ecb/orga/decisions/html/cvdeguindos.en.html",
        "notes":      "Appointed June 2018 for a non-renewable eight-year term.",
    },
    {
        "regulator":  "ECB",
        "role":       "Executive Board (Chief Economist)",
        "name":       "Philip Lane",
        "term_end":   "2027-05-31",
        "term_type":  "Eight-year term end",
        "source_url": "https://www.ecb.europa.eu/ecb/orga/decisions/html/cvlane.en.html",
        "notes":      "Appointed June 2019; non-renewable.",
    },
]
