...
const SOURCE_STYLES = {
  ...
  polling: { bg: 'bg-emerald-100', text: 'text-emerald-700', bar: '#10b981', label: 'Polling' },
  manifold: { bg: 'bg-pink-100', text: 'text-pink-700', bar: '#ec4899', label: 'Manifold' },
  metaculus: { bg: 'bg-cyan-100', text: 'text-cyan-700', bar: '#06b6d4', label: 'Metaculus' },
}
