"""Sentry initialization for the whale-dashboard subproduct.
...
log = logging.getLogger("whale.observability")
...
def detect_release() -> str:
    ...
    if env:
        return env
    try:
        # __file__ lives at <repo>/whale-dashboard/observability.py
...
def init_sentry(platform: str = "whale") -> bool:
    """Initialize Sentry if SENTRY_DSN_WHALE (or SENTRY_DSN) is set.
    ...
    """
    dsn = (
        os.getenv("SENTRY_DSN_WHALE", "").strip()
